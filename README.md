### Hi there 👋🏻
### I'm Vidhan, a Computer Science students who wants learn more, and upgrade myself in both technical and communicational skills 🚀
> Currently a memeber in `GDSC` and havhands-on experience in  `C` `C++` `Java` `Python` `JavaScript` `ReactJs` `Kotlin` and the list goes on...\
...
- 😄 Pronouns: Red, Vinnu
- 📫 How to reach me: [`X - @itsvidhanreddy`](x.com/itsvidhanreddy)
<!--
